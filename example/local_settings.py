...
# not able to connect to smtp host from graphite host because of networking problems
...
REMOTE_USER_MIDDLEWARE = 'graphite.customauth.ForwardedUserMiddleware'
...
#
CARBONLINK_HOSTS = [x.strip() for x in os.environ.get("CARBONLINK_HOST", "").split(",")]
